  ...
  <div class="flex flex-col items-center">
    ...
    <form class="w-3/4">
      ...
      <div>
        ...
        <input
          class="w-3/4 border-2 border-white border-b-slate-300 mb-4 p-2 focus:border-orange-500 focus:outline-none"
          type="text"
          name="tag"
          id="tag"
          v-model="tag"
    ...
    <div class="flex gap-6">
      ...
      <button
        class="bg-white border-2 border-slate-700 py-3 px-4 ml-4 hover:bg-slate-200"
        @click="$router.push('/')">
      Cancel
      </button>
    </div>
